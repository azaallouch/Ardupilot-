...
packet = (char *)malloc (256 *sizeof (char));
printf("length is %d\n", length);
aes_encrypt((uint8_t *)packet, length, key, iv);
...
printf("cypher text:\n");
   ...
   printf("\n\n");
//printf("the size of cyphertext is %u\n", length);
   //printf("\n\n");

//aes_decrypt((uint8_t *)packet, length, key, iv);
